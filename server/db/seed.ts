  ...
  const pages = [
    {
      ...
      bodyMd: [
        ...
        '## Nuestra misión',
        '',
        'Proteger la salud, el patrimonio y la tranquilidad de nuestros clientes mediante un **manejo integrado de plagas** eficaz, seguro para las personas y respetuoso con el medio ambiente, entregando siempre un servicio cercano, puntual y documentado.',
        '',
        '## Nuestra visión',
        '',
        'Ser la empresa de control y mantención ambiental **de mayor confianza de la zona poniente de Santiago**: la que los hogares recomiendan a sus vecinos y la que las empresas eligen cuando el estándar sanitario no admite improvisación.',
        '',
        '## Nuestro objetivo',
        '',
        'Que cada cliente deje de preocuparse por las plagas. No perseguimos una visita puntual, sino un **ambiente controlado en el tiempo**: diagnosticar el origen, eliminar el problema y dejar instalado un plan de prevención que evite que vuelva.',
        '',
        '## Nuestros valores',
        '',
